  ...
  return (
    <div id="contact" className="bg-primary-medium pb-10 px-4">
      ...
      <div className="flex flex-wrap lg:justify-center">
        <a
          className="p-4 w-full md:w-auto hover:bg-primary-light rounded-md"
          href="https://api.whatsapp.com/send?phone=5573999768043"
          target="_blank"
        ...
        >
          <div className="flex flex-wrap lg:justify-start  ">
            ...
            <div className="px-2">
              ...
              <strong className="text-white font-semibold text-2xl">
                (73) 99976-8043
              </strong>
            </div>
          </div>
        ...
        <a
          className="p-4 w-full md:w-auto hover:bg-primary-light rounded-md"
          href="mailto:murilodevs@gmail.com"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="p-4 w-full md:w-auto hover:bg-primary-light rounded-md"
          href="https://github.com/goismurilo"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className="flex flex-wrap justify-start ">
