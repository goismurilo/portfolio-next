            ...
            <div className="flex flex-wrap justify-center">
                ...
                <div className="w-64 bg-violet-200 p-4 rounded-lg mt-4 mr-2">
                    ...
                    <span className='py-2 px-8 my-4 rounded-lg bg-second-dark hover:opacity-75 text-white flex justify-center'>
                        <a className="align-middle-text" href="https://acessabr-flame.vercel.app/BA/Eun%C3%A1polis">Ver Projeto</a>
                    </span>
                ...
                <div className="w-64 bg-violet-200 p-4 rounded-lg mt-4 mr-2">
                    ...
                    <span className='py-2 px-8 my-4 rounded-lg bg-second-dark hover:opacity-75 text-white flex justify-center'>
                        <a className="align-middle-text" href="https://github.com/goismurilo/digital-cast">Ver Projeto</a>
                    </span>
